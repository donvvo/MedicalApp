...
class UpperExtremitySummaryView(LoginRequiredMixin, StaffuserRequiredMixin, TemplateView):
    template_name = 'medicalforms/table_summary/upper_extremity_summary.html'
    raise_exception = True
